...
Route::livewire('/campus/berita/detail/{id}', 'frontend.berita.detail')->layout('layouts.master')->name('berita.detail');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::livewire('/campus/fasilitas', 'backend.campus.fasilitas.index')->layout('layouts.app')->name('campus.fasilitas.index');
    Route::livewire('fasilitas/create', 'backend.campus.fasilitas.create')->layout('layouts.app')->name('fasilitas.create');
    Route::livewire('fasilitas/edit/{id}', 'backend.campus.fasilitas.edit')->layout('layouts.app')->name('fasilitas.edit');
